...
from objects import Ray, Sphere, Light, Scene, Camera, Plane, Cylinder, Paraboloid

def main():
    width, height = 800, 600
    fov = 90
    
    # Set camera position and direction to look at the objects
    ...
    scene = Scene(camera, width, height, ambient_light_intensity=ambient_intensity, ambient_light_color=ambient_color)
    ...
    light2 = Light(light_position2, light_intensity2, light_color2)
